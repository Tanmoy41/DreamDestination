...
if (strlen($_SESSION['adm_id']) == 0) {
  ...
  if (isset($_POST['update'])) {
    ...
    $sql = mysqli_query($conn, "update room_booking_details set status='$status' where book_id='$form_id'");
    $sql = mysqli_query($conn, "update room_booking_details set remark='$remark' where book_id='$form_id'");
