					...
					{        
									if($fsize>=1000000)
									...
									else
										{
												...
												$sql = "update hotel set hotel_name='$res_name',email='$_POST[email]',location='$_POST[address]',hotel_image='$fnew' where hotel_id='$_GET[res_upd]' ";  // store the submited data ino the database :images												mysqli_query($conn, $sql); 
                        ...
                        <div class="card card-outline-primary">
                            ...
                            <div class="card-body">
                                <form action='' method='post'  enctype="multipart/form-data">
                                    <div class="form-body">
                                       <?php $ssql ="select * from hotel where hotel_id='$_GET[res_upd]'";
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="res_name" value="<?php echo $row['hotel_name'];  ?>" class="form-control" placeholder="John doe">
                                                   </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 ">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="desc" type="text" style="height:100px;" class="form-control" > <?php echo $row['desc']; ?> </textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 ">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="address" type="text" style="height:100px;" class="form-control" > <?php echo $row['location']; ?> </textarea>
                                                </div>
                                            </div>
                                        </div>
