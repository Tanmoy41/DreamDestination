                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $sql = "SELECT reginfo.*, room_booking_details.* FROM reginfo INNER JOIN room_booking_details ON reginfo.id=room_booking_details.id ";
                                            ...
                                            if (!mysqli_num_rows($query) > 0) {
                                                ...
                                                while ($rows = mysqli_fetch_array($query)) {
                                                    ...
                                                    ?>
                                                    <?php
                                                    echo '	<td>' . $rows['check_in_date'] . '</td>';
                                                    echo '	<td>' . $rows['check_out_date'] . '</td>';
                                                    ?>
                                                    <td>
                                                        <a href="delete_bookings.php?order_del=<?php echo $rows['book_id']; ?>"
                                                            onclick="return confirm('Are you sure?');"
                                                            class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i
                                                                class="fa fa-trash-o" style="font-size:16px"></i></a>
                                                        <?php
                                                        echo '<a href="view_booking.php?user_upd=' . $rows['book_id'] . '" " class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="fa fa-edit"></i></a>
																									</td>
																									</tr>';
