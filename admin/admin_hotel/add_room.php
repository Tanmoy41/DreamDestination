					...
					{        
									if($fsize>=1000000)
									...
									else
										{
												...
												$sql = "INSERT INTO rooms(hotel_id,room_name,room_price,room_desc,room_image) VALUE('".$_POST['res_name']."','".$_POST['d_name']."','".$_POST['price']."','".$_POST['about']."','".$fnew."')";  // store the submited data ino the database :images
                ...
                <!-- Start Page Content -->
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Add Room</h4>
                            </div>
                            <div class="card-body">
