                    ...
                    <div class="col-md-3">
                        <div class="card p-30">
                            <div class="media">
                                ...
                                <div class="media-body media-text-right">
                                    <h2><?php $sql="select * from reginfo";
												$result=mysqli_query($conn,$sql); 
													$rws=mysqli_num_rows($result);
					...
					<div class="col-md-3">
                        <div class="card p-30">
                            <div class="media">
                                ...
                                <div class="media-body media-text-right">
                                    <h2><?php $sql="select * from room_booking_details";
												$result=mysqli_query($conn,$sql); 
													$rws=mysqli_num_rows($result);
													
													echo $rws;?></h2>
                                    <p class="m-b-0">Total Bookins</p>
                                </div>
                            </div>
                        </div>
                    </div>	                   
                    ...
                    <div class="col-md-4">
                        <div class="card p-30">
                            <div class="media">
                                ...
                                <div class="media-body media-text-right">
                                    <h2><?php $sql="select * from room_booking_details WHERE status = 'in process' ";
												$result=mysqli_query($conn,$sql); 
													$rws=mysqli_num_rows($result);
                    ...
                    <div class="col-md-4">
                        <div class="card p-30">
                            <div class="media">
                                ...
                                <div class="media-body media-text-right">
                                    <h2><?php $sql="select * from room_booking_details WHERE status = 'closed' ";
												$result=mysqli_query($conn,$sql); 
													$rws=mysqli_num_rows($result);
