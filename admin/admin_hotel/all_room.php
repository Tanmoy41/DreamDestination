                    ...
                    <div class="col-12">
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">All Room</h4>
                            </div>
                                        ...
                                        <tbody>
												...
												$query=mysqli_query($conn,$sql);
													...
													if(!mysqli_num_rows($query) > 0 )
														{
															echo '<td colspan="11"><center>No Room</center></td>';
														}
													else
														{				
																	while($rows=mysqli_fetch_array($query))
																		{
																				$mql="select * from hotel where hotel_id='".$rows['hotel_id']."'";
																				$newquery=mysqli_query($conn,$mql);
																				$fetch=mysqli_fetch_array($newquery);
																				
																				
																					echo '<tr><td>'.$fetch['hotel_name'].'</td>
																					
																								<td>'.$rows['room_name'].'</td>
																								<td>'.$rows['room_desc'].'</td>
																								<td>৳'.$rows['room_price'].'</td>
																								
																								
																								<td><div class="col-md-3 col-lg-8 m-b-10">
																								<center><img src="Hotel_img/rooms/'.$rows['room_image'].'" class="img-responsive  radius" style="max-height:100px;max-width:150px;" /></center>
																								</div></td>
																								
																							
																									 <td><a href="delete_room.php?menu_del='.$rows['room_id'].'" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
																									 <a href="update_room.php?menu_upd='.$rows['room_id'].'" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="fa fa-edit"></i></a>
																									</td></tr>';
