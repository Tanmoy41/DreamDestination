...
if (isset($_POST['submit']))           //if upload btn is pressed
{
    ...
    if (empty($_POST['d_name']) || empty($_POST['about']) || $_POST['price'] == '' || $_POST['res_name'] == '') {
        ...
        $store = "Hotel_img/rooms/" . basename($fnew);
        ...
        if ($extension == 'jpg' || $extension == 'png' || $extension == 'gif') {
            if ($fsize >= 1000000) {
                ...
                $sql = "update rooms set hotel_id='$_POST[res_name]',room_name='$_POST[d_name]',room_desc='$_POST[about]',room_price='$_POST[price]',room_image='$fnew' where room_id='$_GET[menu_upd]'";
                mysqli_query($db, $sql);
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-cutlery"
                                    aria-hidden="true"></i><span class="hide-menu">Room</span></a>
                            <ul aria-expanded="false" class="collapse">
                    ...
                    <div class="card card-outline-primary">
                        ...
                        <div class="card-body">
                            <form action='' method='post' enctype="multipart/form-data">
                                <div class="form-body">
                                    <?php $qml = "select * from rooms where room_id='$_GET[menu_upd]'";
                                    ...
                                    <div class="row p-t-20">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="d_name"
                                                    value="<?php echo $roww['room_name']; ?>" class="form-control"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group has-danger">
                                                ...
                                                <input type="text" name="about" value="<?php echo $roww['room_desc']; ?>"
                                    ...
                                    <div class="row p-t-20">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="price" value="<?php echo $roww['room_price']; ?>"
