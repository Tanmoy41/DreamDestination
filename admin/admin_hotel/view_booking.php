                    ...
                    <div class="col-12">
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">View Bookings</h4>
                            </div>
                                ...
                                <div class="table-responsive m-t-20">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                           <?php
											$sql="SELECT reginfo.*, room_booking_details.* FROM reginfo INNER JOIN room_booking_details ON reginfo.id=room_booking_details.id where book_id='".$_GET['user_upd']."'";
											...
											<tr>
												    ...
												    <td><center><?php echo $rows['username']; ?></center></td>
													   <td><center>
													   <a href="javascript:void(0);" onClick="popUpWindow('order_update.php?form_id=<?php echo htmlentities($rows['book_id']);?>');" title="Update order">
											...
											<tr>
													    <td><center>
													   <a href="javascript:void(0);" onClick="popUpWindow('userprofile.php?newform_id=<?php echo htmlentities($rows['book_id']);?>');" title="Update order">
											...
											<tr>
												    ...
												    <td><center><?php echo $rows['room_type']; ?></center></td>
											...
											<tr>
													<td><strong>Date:</strong></td>
												     <td><center><?php echo $rows['check_in_date']; ?></center></td>
