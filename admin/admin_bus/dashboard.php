                                ...
                                <div class="col-md-4">
                                    <div class="card p-30">
                                        <div class="media">
                                            ...
                                            <div class="media-body media-text-right">
                                                <h2>
                                                    <?php $sql = "select * from booking WHERE status = 'in process' ";
                                                    $result = mysqli_query($conn, $sql);
                                                    $rws = mysqli_num_rows($result);
                                ...
                                <div class="col-md-4">
                                    <div class="card p-30">
                                        <div class="media">
                                            ...
                                            <div class="media-body media-text-right">
                                                <h2>
                                                    <?php $sql = "select * from booking WHERE status = 'closed' ";
                                                    $result = mysqli_query($conn, $sql);
                                                    $rws = mysqli_num_rows($result);
                                ...
                                <div class="col-md-4">
                                    <div class="card p-30">
                                        <div class="media">
                                            ...
                                            <div class="media-body media-text-right">
                                                <h2>
                                                    <?php $sql = "select * from booking WHERE status = 'rejected' ";
                                                    $result = mysqli_query($conn, $sql);
                                                    $rws = mysqli_num_rows($result);

                                                    echo $rws; ?>
                                                </h2>
                                                <p class="m-b-0">Cancelled Bookings</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card p-30">
                                        <div class="media">
                                            ...
                                            <div class="media-body media-text-right">
                                                <h2>
                                                    <?php
                                                    $result = mysqli_query($conn, 'SELECT SUM(Total_fare) AS value_sum FROM booking WHERE status = "closed"');
