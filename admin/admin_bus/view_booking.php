                            ...
                            <div class="card card-outline-primary">
                                ...
                                <div class="table-responsive m-t-20">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $sql = "SELECT reginfo.*, booking.* FROM reginfo INNER JOIN booking ON reginfo.id=booking.id where Booking_id='" . $_GET['user_upd'] . "'";
                                                ...
                                                <td>
                                                    <center>
                                                        <a href="javascript:void(0);"
                                                            onClick="popUpWindow('booking_update.php?form_id=<?php echo htmlentities($rows['Booking_id']); ?>');"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <center>
                                                        <a href="javascript:void(0);"
                                                            onClick="popUpWindow('userprofile.php?newform_id=<?php echo htmlentities($rows['book_id']); ?>');"
                                                            title="Update order">
