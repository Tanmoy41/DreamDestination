...
if(isset($_POST['submit'] ))
{
	...
	$mql = "update reginfo set username='$_POST[uname]', f_name='$_POST[fname]', l_name='$_POST[lname]',email='$_POST[email]',phone='$_POST[phone]',password='".md5($_POST[password])."' where u_id='$_GET[user_upd]' ";
            ...
            <div class="container-fluid">
					 ...
					 <div class="container-fluid">
                        ...
                        <div class="card card-outline-primary">
                            ...
                            <div class="card-body">
							  <?php $ssql ="select * from reginfo where id='$_GET[user_upd]'";
