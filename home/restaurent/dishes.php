...
<head>
    ...
    <link href="css_rest/style.css" rel="stylesheet"> </head>
...
<body>
        ...
        <div class="page-wrapper">
			...
			<?php $ress= mysqli_query($conn,"select * from restaurant where rs_id='$_GET[res_id]'");
									     $rows=mysqli_fetch_array($ress);
                                         $_SESSION['res'] = $rows['title'];  
										  ?>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12  col-md-4 col-lg-4 profile-img">
                                <div class="image-wrap">
                                    <figure><?php echo '<img src="../../admin/admin_rest/Res_img/'.$rows['image'].'" alt="Restaurant logo">'; ?></figure>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
										...
										<form method="post" action='dishes.php?res_id=<?php echo $_GET['res_id'];?>&action=add&id=<?php echo $product['d_id']; ?>'>
                                            <div class="rest-logo pull-left">
                                                <a class="restaurant-logo pull-left" href="#"><?php echo '<img src="../../admin/admin_rest/Res_img/dishes/'.$product['img'].'" alt="Food logo">'; ?></a>
                                            </div>
