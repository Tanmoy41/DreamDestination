...
<head>
    ...
    <link href="css_rest/bootstrap.min.css" rel="stylesheet">
    <link href="css_rest/font-awesome.min.css" rel="stylesheet">
    <link href="css_rest/animsition.min.css" rel="stylesheet">
    <link href="css_rest/animate.css" rel="stylesheet">
    <link href="css_rest/style.css" rel="stylesheet">
</head>
...
<body class="home">
    ...
    <header id="header" class="header-scroll top-header headrom">
        <nav class="navbar navbar-dark">
            <div class="container">
                ...
                <a class="navbar-brand" href="../homepage/home.php"> <img class="img-rounded" src="images/logo.png"
                        style="height:40px; width: 80px;" alt=""> </a>
                <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                    <ul class="nav navbar-nav">
                        <li class="nav-item"> <a class="nav-link active" href="rest_home.php">Home  <span
    ...
    <section class="popular">
        <div class="container">
            ...
            <div class="row">
                <?php
                $query_res = mysqli_query($conn, "select * from dishes LIMIT 6");
                while ($r = mysqli_fetch_array($query_res)) {

                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap">
                                                <div class="figure-wrap bg-image" data-image-src="../../admin/admin_rest/Res_img/dishes/' . $r['img'] . '"></div>
                                                <div class="content">
														...
														<div class="restaurant-wrap">
															<div class="row">
																<div class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center">
																	<a class="restaurant-logo" href="dishes.php?res_id=' . $rows['rs_id'] . '" > <img src="../../admin/admin_rest/Res_img/' . $rows['image'] . '" alt="Restaurant logo"> </a>
																</div>
    ...
    <script src="js_rest/jquery.min.js"></script>
    <script src="js_rest/tether.min.js"></script>
    <script src="js_rest/bootstrap.min.js"></script>
    <script src="js_rest/animsition.min.js"></script>
    <script src="js_rest/bootstrap-slider.min.js"></script>
    <script src="js_rest/jquery.isotope.min.js"></script>
    <script src="js_rest/headroom.js"></script>
    <script src="js_rest/foodpicky.min.js"></script>
</body>
